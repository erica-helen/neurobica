...
export function generateActivitiesDatabase() {
    const activities = [
        ...
        'Reorganize your clothes closet: Try to reorganize your clothes closet in a completely different way than you are used to. ',
        'Learn to play a new musical instrument',
        'Take a dance class in a completely new style: If you are not familiar with dance, sign up for a class in a style that is entirely new to you.',
        'Try creative writing: Challenge your creativity by writing a short story, poem, or play.',
